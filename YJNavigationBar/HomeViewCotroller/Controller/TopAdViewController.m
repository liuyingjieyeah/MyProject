...
@interface TopAdViewController ()<UIScrollViewDelegate>

@property (nonatomic , weak) UIScrollView *scroll;
@property (nonatomic , weak) UILabel *titleLabel;
@property (nonatomic , weak) UILabel *countLabel;
@property (nonatomic , weak) UITextView *textview;
@property (nonatomic , strong) TopAdData *topdata;
...
@implementation TopAdViewController
...
- (void)initNetWork{
    ...
    [PPNetworkHelper GET:_url parameters:nil success:^(id responseObject) {
        self.count = [responseObject[@"imgsum"] intValue];
        self.setname = responseObject[@"setname"];
        
        NSArray *dataarray = [TopAdData mj_objectArrayWithKeyValuesArray:responseObject[@"photos"]];
        // 创建frame模型对象
